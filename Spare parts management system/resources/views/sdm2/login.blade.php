    ...
    <div class="ui two column centered grid ">
      <div class=" ui segment column ">
        <div class="ui form ">
          ...
          <form action="{{ route('sdm2.getloginuser') }}" method="post">
         ...
         @endif
          <center>
          <button class="ui green button buttonLogin" type="submit">เข้าสู่ระบบ</button>
          </form>
          <br>
          <br>
          <a href="{{ route('sdm2.requestuser')}}" class="ui black button  ">สมัครสมาชิก</a>
        </center>
